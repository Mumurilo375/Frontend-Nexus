...
export default function AddProduto() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(
        "Nao foi possivel salvar o game. Verifique os campos e tente novamente.",
      );
    } finally {
      setSaving(false);
    }
          ...
          >
            ...
            <label className="flex flex-col gap-2 text-sm">
              ...
              <input
                ...
                onChange={(event) =>
                  handleFieldChange("releaseDate", event.target.value)
                }
                className="rounded-lg border border-gray-700 bg-black/40 px-3 py-2 outline-none focus:border-blue-500"
              />
            </label>
            ...
            <label className="flex flex-col gap-2 text-sm md:col-span-2">
              ...
              <textarea
                ...
                onChange={(event) =>
                  handleFieldChange("longDescription", event.target.value)
                }
                rows={4}
                className="rounded-lg border border-gray-700 bg-black/40 px-3 py-2 outline-none focus:border-blue-500"
              />
